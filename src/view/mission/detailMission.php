...
<?php
    ...
    $message_succes = isset($_GET['succes']) ? "Ta proposition a été envoyée avec succès au client !" : null;
    ...
    <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
        <div>
            ...
            <p class="mt-2 text-sm text-gray-500">
                <span class="font-medium text-gray-900"><?= ($mission['nom_entreprise']) ?></span>
            </p>
        </div>
        <div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div class="p-6 md:p-8 space-y-8">
                    <div>
                        ...
                        <p class="text-gray-700 leading-relaxed"><?= nl2br(($mission['description'])) ?></p>
                    </div>
                    <div>
                    ...
                    <form action="index.php?page=soumettreProposition" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-2">
                            <div>
                                ...
                                <div class="mt-2">
                                    <input type="number" name="tarif" id="tarif" class="block w-full rounded-md border-0 py-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-900 sm:text-sm sm:leading-6 px-3" placeholder="1000">
                                </div>
                            </div>
                            <div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div class="p-6 md:p-8">
                    ...
                    <dl class="space-y-5">
                        ...
                        <div class="flex items-start">
                            <div class="flex-shrink-0 mt-0.5"><svg class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg></div>
                            <div class="ml-3">
