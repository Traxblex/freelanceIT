    ...
    <div class="container px-6 py-12 mx-auto">
        ...
        <div class="flex flex-col items-center justify-between sm:flex-row">
            <a href="index.php?page=index" class="flex items-center text-gray-800 transition-colors duration-300  dark:hover:text-blue-400 hover:text-blue-500">
                ...
                <a href="#" class="mx-2 text-gray-400 hover:text-blue-500" aria-label="Facebook">
                    <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <a href="#" class="mx-2 text-gray-400 hover:text-blue-500" aria-label="Github">
                    <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            <p class="mt-4 text-sm  sm:mt-0 ">© Copyright 2026 FreelanceIT. tous droits réservés.</p>
        </div>
    </div>
</footer>