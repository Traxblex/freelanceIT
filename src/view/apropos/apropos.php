<section class="bg-white mt-20">
    <div class="container px-6 py-10 mx-auto">
        <h1 class="text-2xl font-semibold text-center 0 capitalize lg:text-3xl">Notre <span class="text-blue-500">Équipe</span></h1>

        <p class="max-w-2xl mx-auto my-6 text-center ">
            Nous sommes une équipe passionnée de professionnels de l'informatique, dédiée à connecter les entreprises avec les meilleurs talents freelances. Notre mission est de faciliter la collaboration et de créer des opportunités pour les développeurs indépendants et les entreprises à la recherche de compétences spécialisées.
        </p>

        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
            <div class="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:hover:border-transparent">
                <div class="flex flex-col sm:-mx-4 sm:flex-row">
                    ...
                    <div class="mt-4 sm:mx-4 sm:mt-0">
                        <h1 class="text-xl font-semibold capitalize md:text-2xl group-hover:text-white">CAMARA ALLAMA MOHAMED</h1>

                        <p class="mt-2 text-gray-500 capitalize group-hover:text-gray-300">Développeur Full Stack</p>
                    </div>
                </div>
